...
from database import add_enrollment
...
class EnrollmentManager:
    def __init__(self, master):
        ...
        self.student_id_entrya= ttk.Entry(master, width=30)
        ...
        self.register_button = ttk.Button(master, text="Зарегистрировать ➕", command=self.register_student)
